...
public class ClinicaControlador implements Serializable {

    private static final long serialVersionUID = 1L;
    
    // Instancia única (Patrón Singleton)
    private static ClinicaControlador instancia;
    ...
    public static ClinicaControlador getInstance() {
        if (instancia == null) {
            instancia = new ClinicaControlador();
        }
        return instancia;
    }
